...
class DataModule(pl.LightningDataModule):
    ...
    def prepare_data(self):
        ...
        if not os.path.isfile(self.concat_mem_file_name):
            ...
            concat = []
            for key in ['agedb_30', 'cfp_fp', 'lfw', 'cplfw', 'calfw', 'cplfw_noised_test']:
...
def val_dataset(data_root, val_data_path, concat_mem_file_name):
    ...
    age_30, cfp_fp, lfw, age_30_issame, cfp_fp_issame, lfw_issame, cplfw, cplfw_issame, calfw, calfw_issame, cplfw_noised_test, cplfw_noised_test_issame = val_data
    val_data_dict = {
        ...
        "cplfw_noised_test": (cplfw_noised_test, cplfw_noised_test_issame),
    }
